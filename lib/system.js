...
function generateBackupSummary() {
  ...
  let dataDirSize = util.getFormattedSize(findDirSize(config.data_dir));
  ...
  return db.ProcessEvent.findAll({
    ...
    for (let machineName in machines)
    {
      ...
      let diskSpace = util.getFormattedSize(findDirSize(path.join(config.data_dir, machineName)));
