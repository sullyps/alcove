...
module.exports = System = {
  ...
  backupProcess: function(machine) {
    ...
    this.fillBuckets(buckets, backupDirectory, machine, this.removeDirectories, rsync);
    var currentTime = new Date(Date.now());
    var nextBackup = this.findNextScheduledTime(machine.schedule, currentTime);
    console.log('Setting timeout for ' + (nextBackup));
    setTimeout(function() { this.backupProcess(machine) }, nextBackup.getTime() - currentTime.getTime());
  }
}
