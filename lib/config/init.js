...
const SPEC = {
  valid: [ 
    ...
    "notifications.sms_accessKey", "notifications.sms_secretKey", "notifications.sms_region",
    "notifications.sms_maxPrice", "notifications.sms_smsType",
    "notifications.sms_to", "notifications.sms_from"
  ],
  required: [
    "ip", "port", "log_dir", "log_level", "data_dir",
