...
var environmentConfig = {
  development: {
    ...
    rsync: {
      ...
      ssh_key: (backupConfig.rsync.ssh_key !== undefined) ? backupConfig.rsync.ssh_key : rootPath + '/etc/ssh/ssh_key',
      retry: {
        attempts: (backupConfig.rsync.retry.attempts !== undefined) ? backupConfig.rsync.retry.attempts : 3,
        time_multiplier: (backupConfig.rsync.retry.time_multiplier !== undefined) ? backupConfig.rsync.retry.time_multiplier : 3
      }
    },
    notifications: {
