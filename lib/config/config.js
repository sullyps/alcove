...
catch(error) 
{
  ...
  console.error('Create a config file, \'backup.ini\' in ' + rootPath + '/etc/backup/.' +
  '\n    To get up and running, copy the contents of backup.example.ini into a file named' +
  ' backup.ini and change the parameters to appropriate values.\nError: ' + error.message);
  process.exit(-1);
}
