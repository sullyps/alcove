  ...
  rl.question('Username: ', usernameInput => {
    rl.question('Password: ', passwordInput => {
      ...
      .then(user => {
        if (!user)
        {
          exit('Wrong username and/or password.', -6);
        }
    ...
    rl.question('Current Password: ', currentPasswordInput => {
      ...
      .then(match => {
        ...
        rl.question('New Password: ', newPasswordInput => {
          ...
          .then(() => {
            exit('Password updated successfully.', 0);
          });
        });
      });
    });
...
rl.question('What would you like to do? (addUser, deleteUser, changePassword): ', operationInput => {
