      ...
      if (config.notifications) 
      {
            ...
            config.notifications.sms_type)
        {
          try
          {
            ...
            const accessKeyId = config.notifications.sms_accessKey;
            const secretAccessKey = config.notifications.sms_secretKey;
            const region = config.notifications.sms_region;
            const smsTo = config.notifications.sms_to;
            const smsType = config.notifications.sms_type;
