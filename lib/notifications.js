      ...
      if (config.notifications) 
      {
            ...
            config.notifications.sms_secretKey && config.notifications.sms_region)
        {
          try
          {
            ...
            var from = config.notifications.sms_from;
            var to = config.notifications.sms_to;
            // TODO: What to do about Optional configuations
            var maxPrice = config.notifications.sms_maxPrice;
            var smsType = config.notifications.sms_smsType;
            dispatchers.push(require('./notifications/sms')(from, to, accessKeyId, secretAccessKey, region, maxPrice, smsType));
          }
          catch (error)
          {
